...
public class SampleAppConstants {
    //API_KEY is given by TraknPay. Please Copy Paste Here.
    public static final String PG_API_KEY = "<your_API_key>";

    //HOSTNAME is given by TraknPay. Please Copy Paste Here.
    ...
    //PG_CURRENCY is given by TraknPay. Only "INR" Allowed.
    public static final String PG_CURRENCY = "INR";

    //PG_COUNTRY is given by TraknPay. Only "IND" Allowed.
