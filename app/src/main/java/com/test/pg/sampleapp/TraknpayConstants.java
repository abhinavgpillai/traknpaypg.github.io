...
public class TraknpayConstants {
    ...
    public static final String PAYMENT_URL = "https://biz.traknpay.in/v2/paymentrequest";
    public static final String TEST_PAYMENT_URL = "https://biz.traknpay.in/v1/paymentrequest";
